// src/app/salary/ClientShell.tsx
'use client';
...
export default function ClientShell() {
  ...
  const [hourlyStr, setHourlyStr] = useState<string>(NOK(hourly));
  ...
  const commitHourly = () => {
    ...
    if (parsed === null) {
      setHourlyStr(NOK(hourly));
      return;
    }
    setHourly(parsed);
    setHourlyStr(NOK(parsed));
  };
      ...
      >
        ...
        {salaryType === 'timelønn' && (
          ...
          >
            <TopBar
              hourlyStr={hourlyStr}
              setHourlyStrAction={setHourlyStr}
              onCommitHourlyAction={commitHourly}
            ...
            <ShiftConfig
              shiftYes={shiftYes}
              setShiftYesAction={setShiftYes}
              shiftMode={shiftMode}
              setShiftModeAction={setShiftMode}
              kveldTillegg={kveldTillegg}
              setKveldTilleggAction={setKveldTillegg}
              nattTillegg={nattTillegg}
              setNattTilleggAction={setNattTillegg}
            ...
            <HoursInput
              shiftYes={shiftYes}
              hVanlig={hVanlig} setHVanligAction={setHVanlig}
              hHellig={hHellig} setHHelligAction={setHHellig}
              hKveld={hKveld}   setHKveldAction={setHKveld}
              hNatt={hNatt}     setHNattAction={setHNatt}
              hOT50={hOT50}     setHOT50Action={setHOT50}
              hOT100={hOT100}   setHOT100Action={setHOT100}
            />
            ...
            <TabelltrekkPanel
              ...
              setTabelltrekkKrAction={setTabelltrekkKr}
              initialMode="percent"
              initialPercent={30}
            />
            ...
            <OvertidSkattPanel
              ...
              setOvertidSkattProsentAction={setOvertidSkattProsent}
          ...
          <div className="mt-2">
            ...
            >
              ...
              <FastRatesPanel
                ...
                setAnnualHoursAction={setAnnualHours}
              ...
              <FastOvertimeHours
                hOT50={fastHOT50}
                setHOT50Action={setFastHOT50}
                hOT100={fastHOT100}
                setHOT100Action={setFastHOT100}
              />
              ...
              <div className="mt-4">
                <TabelltrekkPanel
                  ...
                  setTabelltrekkKrAction={setFastTabelltrekk}
                  initialMode="amount"
                  initialPercent={30}
                />
              </div>
              ...
              {/* Totalt skattetrekk + manuelle felt + utbetalt — ALT innenfor panelet */}
              <BarRow
                label="Totalt Skattetrekk"
